...
public class GLView extends GLSurfaceView
{
    ...
    public GLView(Context context, ArListener listener)
    {
        super(context);
...
//    public void addListener(HelloAR.Listener listener){
//        helloAR.addListener(listener);
//    }
    @Override
